...
3. Create a new database and name it exactly: `studentdb`.
4. Click on the `studentdb` database, go to the **SQL** tab, and run the following query to create the necessary table:
...
2. Type in the URL path to your project folder. For example: `http://localhost/your_project_folder_name/index.php`.
3. You are all set! Start adding students to your new database.
